...
class HomeoLabelApp(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # ---- FIXED COLUMN WIDTHS AUTO-SCALING ----
        col_width_common = int(350 * self.scaling)
        col_width_latin  = int(350 * self.scaling)
    ...
    def update_suggestions(self):
        ...
        # === remove auto-resizing: self.suggestion_table.resizeColumnsToContents() ===
