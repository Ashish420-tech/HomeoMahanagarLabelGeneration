...
class HomeoLabelApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setWindowFlags(QtCore.Qt.Window)      # Native system window
        self.showMaximized()                       # Launch maximized, resizable/minimizable
    ...
    def init_ui(self):
        ...
        self.medicine_search.setStyleSheet("font-size:18pt; padding:10px;")
        self.medicine_search.textChanged.connect(self.update_suggestions)
        left_panel.addWidget(QtWidgets.QLabel("Find Medicine", styleSheet="font-weight:bold; font-size:16pt;"))
        ...
        self.suggestion_table.setStyleSheet("font-size:14pt;")
        self.suggestion_table.cellClicked.connect(self.on_suggestion_clicked)
        left_panel.addWidget(QtWidgets.QLabel("Suggestions", styleSheet="font-weight:bold; font-size:15pt;"))
        left_panel.addWidget(self.suggestion_table)
        self.add_new_btn = QtWidgets.QPushButton("Add New Medicine")
        self.add_new_btn.setStyleSheet("padding:10px; font-size:14pt; font-weight:bold;")
        ...
        self.selected_medicine_label.setStyleSheet("font-weight:bold; font-size:24pt; margin-bottom:16px;")
        ...
        self.potency_input.setStyleSheet("font-size:16pt; padding:7px;")
        ...
        self.dose_input.setStyleSheet("font-size:16pt; padding:7px;")
        ...
        self.time_input.setStyleSheet("font-size:16pt; padding:7px;")
        ...
        self.shop_input.setStyleSheet("font-size:16pt; padding:7px;")
        ...
        self.branch_phone_input.setStyleSheet("font-size:16pt; padding:7px;")
        ...
        self.preview_line1.setStyleSheet("font-weight:bold; font-size:28pt;")
        ...
        self.preview_line2.setStyleSheet("font-weight:bold; font-size:24pt;")
        ...
        self.preview_line3.setStyleSheet("font-size:20pt;")
        ...
        self.preview_line4.setStyleSheet("font-size:18pt;")
        ...
        self.preview_line5.setStyleSheet("font-size:14pt;")
        preview_layout.addWidget(self.preview_line5)
        right_panel.addWidget(QtWidgets.QLabel("Label Preview", styleSheet="font-weight:bold;font-size:18pt;"))
        ...
        self.font_size_spin.setStyleSheet("font-size:16pt;")
        self.font_size_spin.valueChanged.connect(self.update_label_settings)
        controls_layout.addWidget(QtWidgets.QLabel("Font Size:", styleSheet="font-size:16pt;"))
        controls_layout.addWidget(self.font_size_spin)
        self.printer_combo = QtWidgets.QComboBox()
        self.printer_combo.setStyleSheet("font-size:15pt;")
        self.refresh_printers()
        controls_layout.addWidget(QtWidgets.QLabel("Printer:", styleSheet="font-size:16pt;"))
        controls_layout.addWidget(self.printer_combo)
        self.printer_refresh_btn = QtWidgets.QPushButton("Refresh")
        self.printer_refresh_btn.setStyleSheet("padding:12px; font-size:14pt; font-weight:bold;")
