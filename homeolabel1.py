...
class HomeoLabelApp(QtWidgets.QWidget):
    ...
    def search_medicine(self):
        ...
        # Fuzzy search on both common_col and latin_col
    ...
    def print_label(self):
        ...
        c.drawCentredString(1*inch, 0.85*inch, common_name)  # Only Common Name
        ...
        # ------------------- Print Preview / Select Printer -------------------
        try:
            if os.path.exists(label_file):
                # This will open the standard Windows Print dialog
        ...
        QtWidgets.QMessageBox.information(self, "Success", "Label created and record saved!")
