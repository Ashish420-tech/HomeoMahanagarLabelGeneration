...
class HomeoLabelApp(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # Bottom Offset
        self.bottom_offset_spin = QtWidgets.QDoubleSpinBox()
        self.bottom_offset_spin.setRange(0.0, 1.0)
        self.bottom_offset_spin.setSingleStep(0.01)
        self.bottom_offset_spin.setValue(self.bottom_offset)
        self.bottom_offset_spin.setSuffix(" in")
        self.bottom_offset_spin.valueChanged.connect(self.update_label_settings)
        settings_layout.addWidget(QtWidgets.QLabel("Bottom Offset:"))
        settings_layout.addWidget(self.bottom_offset_spin)
    ...
    def update_label_settings(self):
        ...
        self.bottom_offset = self.bottom_offset_spin.value()
    ...
    def print_label(self):
        try:
            ...
            c.setLineWidth(1)
            c.rect(0.05*inch, self.bottom_offset*inch, 1.67*inch, 0.98*inch - self.top_offset*inch - self.bottom_offset*inch)

            y = 0.98*inch - self.top_offset*inch
