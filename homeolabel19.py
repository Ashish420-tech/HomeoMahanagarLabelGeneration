...
class LabelPrinterApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.pdf_path = None
        self.preview_mode = True  # First click = preview; second = print
        self.init_ui()
    ...
    def init_ui(self):
        ...
        layout.addWidget(QtWidgets.QLabel("Top Offset (mm):"))
    ...
    def create_pdf(self):
        """Create the label PDF dynamically."""
    ...
    def handle_print_label(self):
        """Show preview first, print on second click."""
    ...
    def direct_print_label(self):
        """Print directly via system printer."""
