...
# Optional: consider modular split with separate files for UI, data, PDF management
...
class HomeoLabelApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        # Data entry buffer for lazy save
        self.record_buffer = []
    ...
    def init_ui(self):
        ...
        try:
            ...
            printers = []
            logging.warning(f"Failed to get printer list: {e}")
    ...
    def reset_fields(self):
        ...
        self.potency_input.setCurrentIndex(-1)
        self.dose_input.setCurrentIndex(-1)
        self.time_input.setCurrentIndex(-1)
        self.shop_input.setCurrentIndex(-1)
        self.branch_phone_input.setCurrentIndex(-1)
        self.preview_line1.setText('')
        self.preview_line2.setText('')
        self.preview_line3.setText('')
        self.preview_line4.setText('')
        self.preview_line5.setText('')

    def update_label_settings_from_slider(self):
        self.top_offset = self.top_offset_slider.value()
        self.update_preview()
        logging.info(f"Top offset changed to: {self.top_offset}")
    ...
    def update_suggestions(self):
        ...
        # --- New: auto resize columns after populating ---
    ...
    def print_direct(self):
        ...
        try:
            ...
            if not printer_name:
                ...
                return
            win32api.ShellExecute(0, "printto", pdf_file, f'"{printer_name}"', ".", 0)
    ...
    def generate_pdf(self, pdf_file):
        ...
        # Lazy saving: buffer up to 10 records or save on preview/print
        ...
        # Save autocomplete with atomic write and backup
