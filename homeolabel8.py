...
class HomeoLabelApp(QtWidgets.QWidget):
    def __init__(self):
        ...
        # Load data
        self.df_remedies = self.load_remedies()
    ...
    def load_remedies(self):
        ...
        try:
            ...
            return pd.DataFrame(columns=['latin_col', 'common_col'])
    ...
    def init_ui(self):
        ...
        self.suggestion_table.setMinimumWidth(450)
        ...
        self.time_input.setPlaceholderText("Enter times like 8 AM - 12 PM - 4 PM")
        ...
        self.preview_frame.setFixedSize(450, 220)
    ...
    def on_suggestion_clicked(self, row, column):
        item_common = self.suggestion_table.item(row, 0).text()
        item_latin = self.suggestion_table.item(row, 1).text()
        self.medicine_search.setText(item_common)
    ...
    def update_preview(self):
        ...
        self.preview_line2.setText(f"Quantity: {quantity}")
        self.preview_line3.setText(f"Dose: {dose}")
        self.preview_line4.setText(f"Time: {time_val}")
        self.preview_line5.setText(f"{shop}")
        self.preview_line6.setText(f"{branch_phone}")
    ...
    def print_label(self):
        try:
            ...
            c.drawCentredString(0.885*inch, y, f"Quantity: {quantity}")

            y -= 0.13*inch
            c.drawCentredString(0.885*inch, y, f"Dose: {dose}")

            y -= 0.13*inch
            c.drawCentredString(0.885*inch, y, f"Time: {time_val}")
